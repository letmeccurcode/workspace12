        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="lm">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'queryDeptsByPage/1/5','部门列表')">&nbsp;&nbsp;&nbsp;&nbsp;部门列表</a>
                        </dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'page_emplist','员工列表')">&nbsp;&nbsp;&nbsp;&nbsp;员工列表</a>
                        </dd>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" id="2" onclick="showTab(1,'studentlist.html','学生列表')">&nbsp;&nbsp;&nbsp;&nbsp;学生列表</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(2,'studentadd.html','学生新增')">&nbsp;&nbsp;&nbsp;&nbsp;学生新增</a>
                        </dd>
                        <dd><a href="javascript:;" id="2" onclick="showTab(3,'studentbatch.html','学生导入')">&nbsp;&nbsp;&nbsp;&nbsp;学生导入</a>
                        </dd>
                    </dl>
                </li>
