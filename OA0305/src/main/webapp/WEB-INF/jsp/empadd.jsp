...
<div class="layui-container" style="margin-top: 5px">
    <form class="layui-form" action="#" method="post" id="fm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <img alt="个人一寸照片" src="media/images/default.jpg" id="img1" width="180px" height="210px">
            </div>
        </div>
        <div class="layui-form-item">
    ...
    function empAdd() {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 2) {
                    alert(res.msg);
                    <%--location.href = "${pageContext.request.contextPath}/queryEmps/1/5";--%>
                } else {
                    alert(res.msg);
                }
            }
...
<script>
            ...
            function () {
                ...
                var uploadInst = upload.render({
                    ...
                    , done: function (res) {
                        ...
                        console.log(res);
                        if (res.status == 2) {
                            //向p1标签填写内容 把用户上传的图片存储在隐藏域中 保存用户信息用得到
                            $("#p1").val(res.msg);
                            //图片回显
                            $("#img1")[0].src = "${basePath}media/upload/" + res.msg;
                            //如果用户上传成功 就取消用户新增的禁用状态
    ...
    //初始化数据
    function initData() {
        $.getJSON("departall", null, function (arr) {
